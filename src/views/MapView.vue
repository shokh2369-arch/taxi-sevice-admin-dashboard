...
async function loadNearestDrivers(item) {
  ...
  try {
    ...
    const data = await firstSuccess([
      ...
      `/admin/nearest-drivers?ride_request_id=${requestId}&radius_km=${R}`,
      `/admin/nearest-drivers?ride_request_id=${requestId}&max_distance_km=${R}`,
      `/admin/nearest-drivers?ride_request_id=${requestId}&radius=${R}`,
      `/admin/nearest-drivers?requestId=${requestId}`,
      `/admin/nearest-drivers?requestId=${requestId}&radius_km=${R}`,
      `/admin/nearest-drivers?requestId=${requestId}&max_distance_km=${R}`,
      `/admin/nearest-drivers?requestId=${requestId}&radius=${R}`,
      `/admin/nearest-drivers?id=${requestId}`,
      `/admin/nearest-drivers?id=${requestId}&radius_km=${R}`,
      `/admin/nearest-drivers?id=${requestId}&max_distance_km=${R}`,
      `/admin/nearest-drivers?id=${requestId}&radius=${R}`,
      `/api/admin/nearest-drivers?request_id=${requestId}`,
      `/api/admin/nearest-drivers?request_id=${requestId}&radius_km=${R}`,
      `/api/admin/nearest-drivers?request_id=${requestId}&max_distance_km=${R}`,
      `/api/admin/nearest-drivers?request_id=${requestId}&radius=${R}`,
      `/api/admin/nearest-drivers?ride_request_id=${requestId}`,
      `/api/admin/nearest-drivers?ride_request_id=${requestId}&radius_km=${R}`,
      `/api/admin/nearest-drivers?ride_request_id=${requestId}&max_distance_km=${R}`,
      `/api/admin/nearest-drivers?ride_request_id=${requestId}&radius=${R}`,
      `/api/admin/nearest-drivers?requestId=${requestId}`,
      `/api/admin/nearest-drivers?requestId=${requestId}&radius_km=${R}`,
      `/api/admin/nearest-drivers?requestId=${requestId}&max_distance_km=${R}`,
      `/api/admin/nearest-drivers?requestId=${requestId}&radius=${R}`,
      `/api/admin/nearest-drivers?id=${requestId}`,
      `/api/admin/nearest-drivers?id=${requestId}&radius_km=${R}`,
      `/api/admin/nearest-drivers?id=${requestId}&max_distance_km=${R}`,
      `/api/admin/nearest-drivers?id=${requestId}&radius=${R}`,
      `/api/v1/admin/nearest-drivers?request_id=${requestId}`,
      `/api/v1/admin/nearest-drivers?request_id=${requestId}&radius_km=${R}`,
      `/api/v1/admin/nearest-drivers?request_id=${requestId}&max_distance_km=${R}`,
      `/api/v1/admin/nearest-drivers?request_id=${requestId}&radius=${R}`,
      `/api/v1/admin/nearest-drivers?ride_request_id=${requestId}`,
      `/api/v1/admin/nearest-drivers?ride_request_id=${requestId}&radius_km=${R}`,
      `/api/v1/admin/nearest-drivers?ride_request_id=${requestId}&max_distance_km=${R}`,
      `/api/v1/admin/nearest-drivers?ride_request_id=${requestId}&radius=${R}`,
      `/api/v1/admin/nearest-drivers?requestId=${requestId}`,
      `/api/v1/admin/nearest-drivers?requestId=${requestId}&radius_km=${R}`,
      `/api/v1/admin/nearest-drivers?requestId=${requestId}&max_distance_km=${R}`,
      `/api/v1/admin/nearest-drivers?requestId=${requestId}&radius=${R}`,
      `/api/v1/admin/nearest-drivers?id=${requestId}`,
      `/api/v1/admin/nearest-drivers?id=${requestId}&radius_km=${R}`,
      `/api/v1/admin/nearest-drivers?id=${requestId}&max_distance_km=${R}`,
      `/api/v1/admin/nearest-drivers?id=${requestId}&radius=${R}`,
      `/v1/admin/nearest-drivers?request_id=${requestId}`,
      `/v1/admin/nearest-drivers?request_id=${requestId}&radius_km=${R}`,
      `/v1/admin/nearest-drivers?request_id=${requestId}&max_distance_km=${R}`,
      `/v1/admin/nearest-drivers?request_id=${requestId}&radius=${R}`,
      `/v1/admin/nearest-drivers?ride_request_id=${requestId}`,
      `/v1/admin/nearest-drivers?ride_request_id=${requestId}&radius_km=${R}`,
      `/v1/admin/nearest-drivers?ride_request_id=${requestId}&max_distance_km=${R}`,
      `/v1/admin/nearest-drivers?ride_request_id=${requestId}&radius=${R}`,
      `/v1/admin/nearest-drivers?requestId=${requestId}`,
      `/v1/admin/nearest-drivers?requestId=${requestId}&radius_km=${R}`,
      `/v1/admin/nearest-drivers?requestId=${requestId}&max_distance_km=${R}`,
      `/v1/admin/nearest-drivers?requestId=${requestId}&radius=${R}`,
      `/v1/admin/nearest-drivers?id=${requestId}`,
      `/v1/admin/nearest-drivers?id=${requestId}&radius_km=${R}`,
      `/v1/admin/nearest-drivers?id=${requestId}&max_distance_km=${R}`,
...
async function loadNearestRequests(item) {
  ...
  try {
    ...
    const data = await firstSuccess([
      ...
      `/admin/nearest-requests?driverId=${driverId}&radius_km=${R}`,
      `/admin/nearest-requests?driverId=${driverId}&max_distance_km=${R}`,
      `/admin/nearest-requests?driverId=${driverId}&radius=${R}`,
      `/admin/nearest-requests?id=${driverId}`,
      `/admin/nearest-requests?id=${driverId}&radius_km=${R}`,
      `/admin/nearest-requests?id=${driverId}&max_distance_km=${R}`,
      `/admin/nearest-requests?id=${driverId}&radius=${R}`,
      `/api/admin/nearest-requests?driver_id=${driverId}`,
      `/api/admin/nearest-requests?driver_id=${driverId}&radius_km=${R}`,
      `/api/admin/nearest-requests?driver_id=${driverId}&max_distance_km=${R}`,
      `/api/admin/nearest-requests?driver_id=${driverId}&radius=${R}`,
      `/api/admin/nearest-requests?driverId=${driverId}`,
      `/api/admin/nearest-requests?driverId=${driverId}&radius_km=${R}`,
      `/api/admin/nearest-requests?driverId=${driverId}&max_distance_km=${R}`,
      `/api/admin/nearest-requests?driverId=${driverId}&radius=${R}`,
      `/api/admin/nearest-requests?id=${driverId}`,
      `/api/admin/nearest-requests?id=${driverId}&radius_km=${R}`,
      `/api/admin/nearest-requests?id=${driverId}&max_distance_km=${R}`,
      `/api/admin/nearest-requests?id=${driverId}&radius=${R}`,
      `/api/v1/admin/nearest-requests?driver_id=${driverId}`,
      `/api/v1/admin/nearest-requests?driver_id=${driverId}&radius_km=${R}`,
      `/api/v1/admin/nearest-requests?driver_id=${driverId}&max_distance_km=${R}`,
      `/api/v1/admin/nearest-requests?driver_id=${driverId}&radius=${R}`,
      `/api/v1/admin/nearest-requests?driverId=${driverId}`,
      `/api/v1/admin/nearest-requests?driverId=${driverId}&radius_km=${R}`,
      `/api/v1/admin/nearest-requests?driverId=${driverId}&max_distance_km=${R}`,
      `/api/v1/admin/nearest-requests?driverId=${driverId}&radius=${R}`,
      `/api/v1/admin/nearest-requests?id=${driverId}`,
      `/api/v1/admin/nearest-requests?id=${driverId}&radius_km=${R}`,
      `/api/v1/admin/nearest-requests?id=${driverId}&max_distance_km=${R}`,
      `/api/v1/admin/nearest-requests?id=${driverId}&radius=${R}`,
      `/v1/admin/nearest-requests?driver_id=${driverId}`,
      `/v1/admin/nearest-requests?driver_id=${driverId}&radius_km=${R}`,
      `/v1/admin/nearest-requests?driver_id=${driverId}&max_distance_km=${R}`,
      `/v1/admin/nearest-requests?driver_id=${driverId}&radius=${R}`,
      `/v1/admin/nearest-requests?driverId=${driverId}`,
      `/v1/admin/nearest-requests?driverId=${driverId}&radius_km=${R}`,
      `/v1/admin/nearest-requests?driverId=${driverId}&max_distance_km=${R}`,
      `/v1/admin/nearest-requests?driverId=${driverId}&radius=${R}`,
      `/v1/admin/nearest-requests?id=${driverId}`,
      `/v1/admin/nearest-requests?id=${driverId}&radius_km=${R}`,
